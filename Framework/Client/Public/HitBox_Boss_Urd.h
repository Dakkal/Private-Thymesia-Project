...
class CHitBox_Boss_Urd final : public CPartObject
{
protected:
	CHitBox_Boss_Urd(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CHitBox_Boss_Urd(const CHitBox_Boss_Urd& rhs);
	virtual ~CHitBox_Boss_Urd() = default;
...
public:
	static CHitBox_Boss_Urd* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strProtoTag = TEXT(""));
