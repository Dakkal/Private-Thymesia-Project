...
class CState_Attack_Halberd final : public CState
{
private:
	CState_Attack_Halberd(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
	virtual ~CState_Attack_Halberd() = default;
...
public:
	static CState_Attack_Halberd* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
