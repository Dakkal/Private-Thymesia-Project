...
class CState_Attack_GreatSword final : public CState
{
private:
	CState_Attack_GreatSword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
	virtual ~CState_Attack_GreatSword() = default;
...
public:
	static CState_Attack_GreatSword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
