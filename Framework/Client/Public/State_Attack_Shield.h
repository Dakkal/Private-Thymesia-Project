...
class CState_Attack_Shield final : public CState
{
private:
	CState_Attack_Shield(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
	virtual ~CState_Attack_Shield() = default;
...
public:
	static CState_Attack_Shield* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
