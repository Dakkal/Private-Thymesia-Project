...
class CWeapon_Sword final : public CPartObject
{
protected:
...
public:
	static CWeapon_Sword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strProtoTag = TEXT(""));
