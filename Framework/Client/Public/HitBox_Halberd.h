...
class CHitBox_Halberd final : public CPartObject
{
protected:
	CHitBox_Halberd(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CHitBox_Halberd(const CHitBox_Halberd& rhs);
	virtual ~CHitBox_Halberd() = default;
...
public:
	static CHitBox_Halberd* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strProtoTag = TEXT(""));
