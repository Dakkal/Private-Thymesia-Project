...
class CEnemy_TwinSword final : public CLandObject
{
protected:
	CEnemy_TwinSword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEnemy_TwinSword(const CEnemy_TwinSword& rhs);

	virtual ~CEnemy_TwinSword() = default;
...
public:
	static CEnemy_TwinSword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strProtoTag = TEXT(""));
