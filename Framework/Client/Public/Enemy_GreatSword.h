...
class CEnemy_GreatSword final : public CLandObject
{
protected:
	CEnemy_GreatSword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEnemy_GreatSword(const CEnemy_GreatSword& rhs);

	virtual ~CEnemy_GreatSword() = default;
...
public:
	static CEnemy_GreatSword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strProtoTag = TEXT(""));
