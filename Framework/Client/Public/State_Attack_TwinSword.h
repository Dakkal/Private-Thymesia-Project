...
class CState_Attack_TwinSword final : public CState
{
private:
	CState_Attack_TwinSword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
	virtual ~CState_Attack_TwinSword() = default;
...
public:
	static CState_Attack_TwinSword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
