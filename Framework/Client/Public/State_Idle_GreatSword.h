...
class CState_Idle_GreatSword final : public CState
{
private:
	CState_Idle_GreatSword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, STATE eState);
	virtual ~CState_Idle_GreatSword() = default;
