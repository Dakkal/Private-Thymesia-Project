...
class CNpc_Kid final : public CLandObject
{
protected:
	CNpc_Kid(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CNpc_Kid(const CNpc_Kid& rhs);

	virtual ~CNpc_Kid() = default;
...
public:
	static CNpc_Kid* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strProtoTag = TEXT(""));
