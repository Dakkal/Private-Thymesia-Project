...
HRESULT CWeapon_Sword::Initialize_Prototype(const wstring& strProtoTag)
{
	__super::Initialize_Prototype(strProtoTag);

	m_eObjType = OBJECT_TYPE::PART;
	m_strObjectName = TEXT("Enemy_Shield_Sword_Weapon");
...
void CWeapon_Sword::Tick(_float fTimeDelta)
{
...
void CWeapon_Sword::LateTick(_float fTimeDelta)
{
...
HRESULT CWeapon_Sword::Render_LightDepth()
{
...
void CWeapon_Sword::OnCollision_Enter(CGameObject* _pColObj, _float fTimeDelta)
{
...
void CWeapon_Sword::OnCollision_Stay(CGameObject* _pColObj, _float fTimeDelta)
{
	OBJECT_TYPE eObject = _pColObj->Get_ObjectType();
...
void CWeapon_Sword::OnCollision_Exit(CGameObject* _pColObj, _float fTimeDelta)
{
	OBJECT_TYPE eObject = _pColObj->Get_ObjectType();
...
void CWeapon_Sword::OnCollision_Part_Enter(CGameObject* _pColObj, _float fTimeDelta)
{
...
void CWeapon_Sword::OnCollision_Part_Stay(CGameObject* _pColObj, _float fTimeDelta)
{
	CGameObject* pPartOwner = dynamic_cast<CPartObject*>(_pColObj)->Get_PartOwner();
	OBJECT_TYPE eOwnerType = pPartOwner->Get_ObjectType();
	CGameObject::PARTS ePart = dynamic_cast<CPartObject*>(_pColObj)->Get_Part_Index();
...
void CWeapon_Sword::OnCollision_Part_Exit(CGameObject* _pColObj, _float fTimeDelta)
{
	CGameObject* pPartOwner = dynamic_cast<CPartObject*>(_pColObj)->Get_PartOwner();
	OBJECT_TYPE eOwnerType = pPartOwner->Get_ObjectType();
	CGameObject::PARTS ePart = dynamic_cast<CPartObject*>(_pColObj)->Get_Part_Index();
...
HRESULT CWeapon_Sword::Ready_Components()
{
	/* Com_Renderer */
	...
	OBBDesc.vDegree = _float3(0.f, 0.5f, 0.f);
...
CWeapon_Sword* CWeapon_Sword::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strProtoTag)
{
