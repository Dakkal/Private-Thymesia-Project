...
HRESULT CSound_Manager::PlaySoundFile(const wstring& strSoundKey, CHANNELID eCh, _float fVolume)
{
...
HRESULT CSound_Manager::PlayBGM(const wstring& strSoundKey, _float fVolume)
{
	if (nullptr == m_pSystem)
		return E_FAIL;
...
HRESULT CSound_Manager::StopSound(CHANNELID eCh)
{
	if (nullptr == m_pSystem)
		return E_FAIL;
...
HRESULT CSound_Manager::SetChannelVolume(CHANNELID eCh, _float fVolume)
{
	if (nullptr == m_pSystem)
		return E_FAIL;
