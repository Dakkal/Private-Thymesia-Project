...
HRESULT CMesh::Initialize_Prototype(const aiMesh* pAIMesh, _matrix PivotMatrix)
{
...
CMesh* CMesh::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const aiMesh* pAIMesh, _matrix PivotMatrix)
{
