...
HRESULT CTargetManager::Add_RenderTarget(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strTargetTag, _uint iSizeX, _uint iSizeY, DXGI_FORMAT ePixelFormat, const _vector& vColor)
{
...
list<class CRenderTarget*>* CTargetManager::Find_MRT(const wstring& strMRTTag)
{
